       ...
       <div class="right_col" role="main">
          ...
          <div class="">
            ...
            <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="name" placeholder="Company Name" required="required" type="text">
                        </div>
                      </div>
